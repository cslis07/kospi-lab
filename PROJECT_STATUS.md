...
- 🆕 **성장주·기대주 발굴 `/growth`** (2026-08-06) — KRX 시총 상위 유니버스를 배치 스캔해
  확정 성장 35·컨센서스 기대 30·수익성 15·밸류 20 = 100점. 네이버 finance/annual 의 **컨센서스 연도**
  (매출·영업이익·EPS·PER=포워드PER)를 처음 활용. 배지(고성장·기대주·턴어라운드·저평가성장(PEG<1)),
  `?ticker=` 딥링크로 정밀 분석 연결. ⚠ PEG 는 기준 EPS 흑자일 때만(적자 베이스 성장률 금지).
  기록 문서 2종(CHANGELOG·COMPLETENESS) 이 회차부터 운영 시작.
