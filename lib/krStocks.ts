...
export const KR_STOCKS: KrStock[] = [
  ...
  { ticker: '267250.KS', name: 'HD현대',            alt: 'hd hyundai' },
  { ticker: '329180.KS', name: 'HD현대중공업',      alt: 'hd heavy industries' },
  { ticker: '012450.KS', name: '한화에어로스페이스', alt: '한화에어로 aerospace' },
  { ticker: '241560.KS', name: '두산밥캣',          alt: 'doosan bobcat' },
  { ticker: '267260.KS', name: 'HD현대일렉트릭',   alt: 'hd hyundai electric' },
  { ticker: '028300.KS', name: 'HLB',              alt: 'hlb' },
  { ticker: '192820.KS', name: '코스맥스',          alt: 'cosmax' },
  { ticker: '006360.KS', name: 'GS건설',            alt: 'gs e&c' },
  { ticker: '000880.KS', name: '한화',              alt: 'hanwha' },
  { ticker: '069960.KS', name: '현대백화점',        alt: '현백' },
  { ticker: '011170.KS', name: '롯데케미칼',        alt: 'lotte chemical' },
  { ticker: '004370.KS', name: '농심',              alt: 'nongshim' },
  { ticker: '139480.KS', name: '이마트',            alt: 'emart' },
  { ticker: '010060.KS', name: 'OCI홀딩스',        alt: 'oci' },
  { ticker: '180640.KS', name: '한진칼',            alt: 'hanjin kal' },
  { ticker: '028050.KS', name: '삼성엔지니어링',    alt: '삼엔 secl' },
  { ticker: '003600.KS', name: 'SK케미칼',          alt: 'sk chemical' },
  { ticker: '036460.KS', name: '한국가스공사',      alt: 'kogas' },
  { ticker: '007070.KS', name: 'GS리테일',          alt: 'gs retail' },
  { ticker: '271560.KS', name: '오리온',            alt: 'orion' },
  { ticker: '023530.KS', name: '롯데쇼핑',          alt: 'lotte shopping' },
  // ── KOSDAQ ──────────────────────────────────────────────────────────────────
  ...
  { ticker: '278470.KQ', name: '에이피알',          alt: 'apr apr cosmetics' },
  ...
  { ticker: '067160.KQ', name: '아프리카TV',        alt: 'afreeca숲 숲' },
  ...
  { ticker: '251270.KQ', name: '넷마블',            alt: 'netmarble' },
  { ticker: '131970.KQ', name: '두산로보틱스',      alt: 'doosan robotics' },
  { ticker: '950170.KQ', name: 'JTC',               alt: 'jtc' },
  { ticker: '222080.KQ', name: '씨아이에스',        alt: 'cis' },
  { ticker: '394280.KQ', name: '오픈엣지테크놀로지', alt: 'openedge' },
  { ticker: '323990.KQ', name: '롯데렌탈',          alt: 'lotte rental' },
  { ticker: '376300.KQ', name: '디어유',            alt: 'dear u bubble' },
  { ticker: '950160.KQ', name: '코오롱티슈진',      alt: 'kolon tissuegene' },
  { ticker: '403870.KQ', name: '핀텔',              alt: 'fintel' },
  { ticker: '039200.KQ', name: '오스코텍',          alt: 'oscotec' },
  { ticker: '214450.KQ', name: '파마리서치',        alt: 'pharmaresearch' },
  { ticker: '900340.KQ', name: '윙입푸드',          alt: '' },
  { ticker: '036620.KQ', name: '감성코퍼레이션',    alt: '' },
  { ticker: '048410.KQ', name: '현대바이오',        alt: 'hyundai bio' },
  { ticker: '310210.KQ', name: '보로노이',          alt: 'voronoi' },
];
